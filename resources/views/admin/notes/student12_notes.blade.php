...
<html lang="en">
<head>
    <title>ملاحظات طلاب 12 - الادمن </title>
    <meta charset="utf-8">
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <div class="page-title">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="mb-0" style="font-family: 'Cairo', sans-serif;"> ملاحظات طلاب 12</h4>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}" class="default-color">الرئيسيه</a></li>
                        <li class="breadcrumb-item active">ملاحظات طلاب 12</li>
                    </ol>
                </div>
            </div>
        </div>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('edit.note12',$note->id) }}" method="post" autocomplete="off">
                                                            @csrf
                                                            <div class="form-row">
                                                                <div class="col">
                                                                    <label for="title">الطالب 12</label>
                                                                    <input class="form-control form-control-lg" value="{{ $note->Student12->name }}" readonly>
