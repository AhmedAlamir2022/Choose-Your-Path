                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        ...
                        <ul id="users" class="collapse" data-parent="#users">
                            <li> <a href="{{ route('all.admins') }}">الادمن</a> </li>
                            <li> <a href="{{ route('all.11_students') }}">طلبه 11</a> </li>
                            <li> <a href="{{ route('all.12_students') }}">طلبه 12</a> </li>
                        </ul>
                    </li>
                    <!-- Specilization-->
                    <li>
                        ...
                        <ul id="Universtey" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('Universtey.index')}}">قائمه الجامعات والكليات</a></li>
                        </ul>
                    </li>
                    <!-- Features -->
                    <li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#Complaints">
                            <div class="pull-left"><i class="fa fa-building"></i><span
                                    class="right-nav-text">الملاحظات</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="Complaints" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('notes.student11')}}">ملاحظات طلاب 11</a></li>
                            <li><a href="{{route('notes.student12')}}">ملاحظات طلاب 12</a></li>
                        </ul>
                    </li>
                    <!-- Doucments-->
{{--                    <li>--}}
...
{{--                    </li>--}}
                    ...
                    <!-- Profile-->
                    <li>
                        <a href="{{ route('admin.profile') }}"><i class="ti-user"></i><span class="right-nav-text">البيانات الشخصيه</span></a>
                    </li>
                    <!-- Change Password-->
                    <li>
                        <a href="{{ route('change.password') }}"><i class="ti-settings"></i><span class="right-nav-text">تغيير كلمه السر</span></a>
                    </li>
                    <!-- Logout-->
                    <li>
                        <a class="dropdown-item" href="{{ route('admin.logout') }}" ><i class="text-info ti-lock"></i>تسجيل الخروج</a>
                    </li>
                    <br><hr>
                </ul>
            </div>
