...
<head>
    ...
    <title>تسجيل الدخول - طالب 11</title>
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{URL::asset('frontend/images/favicon1.png')}}" />
    <!-- Font -->
            ...
            <div class="row justify-content-center no-gutters vertical-align">
                ...
                <div class="col-lg-4 col-md-6 bg-white">
                    <div class="login-fancy pb-40 clearfix">
                        ...
                        <form method="POST" action="{{ route('11student.login') }}">
                            @csrf
                            ...
                            <div class="section-field mb-20">
                                <label class="mb-10" for="Password">كلمه السر </label>
