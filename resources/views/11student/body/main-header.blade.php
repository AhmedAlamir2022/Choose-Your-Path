                ...
                <div class="dropdown-header">
                    <div class="media">
                        <div class="media-body">
                            <h5 class="mt-0 mb-0">{{ Auth::guard('11student')->user()->name }}</h5>
                            <span>{{ Auth::guard('11student')->user()->email }}</span>
                        </div>
                    </div>
                </div>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="{{ route('11student.profile') }}"><i class="text-warning ti-user"></i>البيانات الشخصيه</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="{{ route('11student.change.password') }}"><i class="text-info ti-settings"></i>تغيير كلمه السر</a>
                <div class="dropdown-divider"></div>
