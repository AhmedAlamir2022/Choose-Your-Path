...
<html lang="en">
<head>
    <title> بيانات البانار - طالب 12</title>
    <meta charset="utf-8">
 ...
 Main content -->
    ...
    <div class="content-wrapper">
        <div class="page-title">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="mb-0" style="font-family: 'Cairo', sans-serif;"> بيانات البانار</h4>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                        <li class="breadcrumb-item"><a href="{{ route('12student.dashboard') }}" class="default-color">الرئيسيه</a></li>
                        <li class="breadcrumb-item active"> بيانات البانار</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card card-statistics h-100">
                    <div class="card-body">
                        ...
                        <form autocomplete="off" >
                            <hr>
                            <h4 style="font-family: 'Cairo', sans-serif; text-align: center;">تفاصيل الجامعه</h4>
                            <hr>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>الصوره الاولى</label>
                                        <img class="form-control" readonly src="{{ asset($universty->image1) }}" style="width: 300px; height: 300px;">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <img class="form-control" readonly src="{{ asset($universty->image2) }}" style="width: 300px; height: 300px;">
                                    </div>
                                </div>
                            </div><br>
                            <div class="row">
                            ...
                            <h4 style="font-family: 'Cairo', sans-serif; text-align: center;">تخصصات الجامعه</h4>
                            <hr>
